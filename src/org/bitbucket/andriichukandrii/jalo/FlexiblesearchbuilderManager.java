 ...
 */
package org.bitbucket.andriichukandrii.jalo;
...
import org.bitbucket.andriichukandrii.constants.FlexiblesearchbuilderConstants;



/**
 * This is the extension manager of the Flexiblesearchbuilder extension.
 */
public class FlexiblesearchbuilderManager extends GeneratedFlexiblesearchbuilderManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(FlexiblesearchbuilderManager.class);
	 ...
	 */
	public static FlexiblesearchbuilderManager getInstance()
	{
		return (FlexiblesearchbuilderManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FlexiblesearchbuilderConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FlexiblesearchbuilderManager() // NOPMD 
	{
		LOG.debug("constructor of FlexiblesearchbuilderManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of FlexiblesearchbuilderManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of FlexiblesearchbuilderManager called, current tenant: {}", getTenant().getTenantID());
	}
